...
namespace GeneFinder.Models
{
    ...
    public class smorf : ISerializable
    {
        ...
        public string ConservationString { get; set; }
        ...
        public smorf(string codingClassifierLine)
        {
            ...
            this.GCcontent = this.GCcontent / (float)this.sequence.Length;
        ...
        public smorf(PossibleSmorf possibleSmorf, CodingScore score)
        {
            ...
            this.GCcontent = this.GCcontent / this.sequence.Length;
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("GCcontent", GCcontent);
            info.AddValue("ConservationAverage", ConservationAverage);
            info.AddValue("ConservationPosterior", ConservationPosterior);
            info.AddValue("ConservationPrevious", ConservationPrevious);
            info.AddValue("ConservationString", ConservationString);
        ...
        public smorf(SerializationInfo info, StreamingContext context)
        {
            ...
            GCcontent = (float)info.GetValue("GCcontent", typeof(float));
            ConservationAverage = (float)info.GetValue("ConservationAverage", typeof(float));
            ConservationPosterior = (float)info.GetValue("ConservationPosterior", typeof(float));
            ConservationPrevious = (float)info.GetValue("ConservationPrevious", typeof(float));
            ConservationString = (string)info.GetValue("ConservationString", typeof(string));
